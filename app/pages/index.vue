...
const fashionMuslimProducts = computed(() => {
    if (!products.value) return [];
    return products.value.filter(p => p.category === "fashion-muslim").slice(0, 6);
});

const pakaianDalamProducts = computed(() => {
    if (!products.value) return [];
    return products.value.filter(p => p.category === "pakaian-dalam").slice(0, 6);
});
</script>
        ...
        <section class="mb-20">
            ...
            <div class="flex flex-col items-start md:flex-row gap-10">
                ...
                <div class="md:w-[30%] space-y-6">
                    ...
                    <NuxtLink to="/categories/fashion-muslim" class="inline-block bg-black text-white text-xs font-bold px-6 py-3 uppercase tracking-widest hover:bg-gray-800 transition">
        ...
        <section class="mb-20">
            ...
            <div class="flex flex-col items-start md:flex-row gap-10">
                ...
                <div class="md:w-[30%] space-y-6">
                    ...
                    <NuxtLink to="/categories/pakaian-dalam" class="inline-block bg-black text-white text-xs font-bold px-6 py-3 uppercase tracking-widest hover:bg-gray-800 transition">
                        Explore All Products
                    </NuxtLink>
                </div>
